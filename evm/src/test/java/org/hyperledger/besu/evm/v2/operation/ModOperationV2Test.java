...
class ModOperationV2Test extends BinaryOperationV2Test {

  public ModOperationV2Test() {
    super(new ModOperationV2(new FrontierGasCalculator()));
  }
  ...
  static Iterable<Arguments> data() {
    return List.of(
        ...
        Arguments.of(
            "0x2345435232423567342343523242356734234352324235673423",
