...
public class UInt256ParameterisedTest {
   ...
   */
  static UInt256 fromBigInteger(final java.math.BigInteger value) {
    if (value.signum() < 0) {
  ...
  static BigInteger toBigInteger(final UInt256 value) {
  ...
  @ParameterizedTest
  @MethodSource("provideBinaryTestCases")
  void testSModWithUnsignedCases(final BigInteger a, final BigInteger b) {
    if (b.equals(BigInteger.ZERO)) {
      return; // Skip division by zero
    }
