...
import org.hyperledger.besu.evm.operation.SigDataCopyOperation;
...
public class MainnetEVMs {
  ...
  private static void registerBogotaOperations(
    ...
    // EIP-8141: frame transaction approval and introspection operations
    ...
    registry.put(new SigDataCopyOperation(gasCalculator));
  }
