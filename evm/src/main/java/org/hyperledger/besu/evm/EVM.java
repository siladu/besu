...
public class EVM {
  ...
  // Optimized operation flags (used by the v1 runToHalt switch dispatch)
  ...
  public Optional<Bytes> getChainId() {
    Operation op = operations.get(ChainIdOperationV2.OPCODE);
    if (op instanceof ChainIdOperationV2 chainIdOperation) {
