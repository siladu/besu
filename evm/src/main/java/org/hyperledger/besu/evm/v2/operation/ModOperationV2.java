...
public class ModOperationV2 extends AbstractFixedCostOperationV2 {
  ...
  /** The Mod operation success result. */
  static final OperationResult modSuccess = new OperationResult(5, null);
  ...
  public static OperationResult staticOperation(final MessageFrame frame, final long[] stack) {
    ...
    frame.setTopV2(StackArithmetic.mod(stack, frame.stackTopV2()));
    return modSuccess;
  }
}
