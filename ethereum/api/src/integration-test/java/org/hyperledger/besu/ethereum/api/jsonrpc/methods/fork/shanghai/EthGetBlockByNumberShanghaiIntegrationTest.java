 ...
 */
package org.hyperledger.besu.ethereum.api.jsonrpc.methods.fork.shanghai;
...
public class EthGetBlockByNumberShanghaiIntegrationTest {
  ...
  public static void setUpOnce() throws Exception {
    final String genesisJson =
        Resources.toString(BlockTestUtil.getTestShanghaiGenesisUrl(), Charsets.UTF_8);

    BLOCKCHAIN =
        new JsonRpcTestMethodsFactory(
            new BlockchainImporter(BlockTestUtil.getTestShanghaiBlockchainUrl(), genesisJson));
  }
  ...
  private JsonRpcResponse expectedLatestBlockHashes() {
    ...
    out.put(JsonRpcResponseKey.DIFFICULTY, "0x0");
    out.put(JsonRpcResponseKey.EXTRA_DATA, "0x");
    out.put(JsonRpcResponseKey.GAS_LIMIT, "0x1c9c380");
    ...
    out.put(
        ...
        "0x938ea94ef5809549cbfd2ca7cd482a24c27d26dd615b5f5855419fc362468605");
    out.put(JsonRpcResponseKey.NONCE, "0x0000000000000000");
    ...
    out.put(
        ...
        "0xe15d9c91efac74927497d7df1f2c5be1453bf617cdc488e02614645fc50c7754");
    out.put(
        JsonRpcResponseKey.RECEIPTS_ROOT,
        "0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421");
    out.put(
        JsonRpcResponseKey.STATE_ROOT,
        "0x9f813bed08be8d1be2504ed3bb83dcef3617903ecb105751af86a880241830f3");
    out.put(JsonRpcResponseKey.SIZE, "0x220");
    out.put(JsonRpcResponseKey.TIMESTAMP, "0x63cb633d");
    out.put(JsonRpcResponseKey.TOTAL_DIFFICULTY, "0x1");
    out.put(
        JsonRpcResponseKey.TRANSACTION_ROOT,
        "0x6075dd391cf791c74f9e01855d9e5061d009c0903dc102e8b00bcafde8f92839");
    out.put(JsonRpcResponseKey.BASEFEE, "0x7");
    out.put(
        JsonRpcResponseKey.WITHDRAWALS_ROOT,
        "0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421");
  ...
  //
  //  /**
  //   * The Boolean type second parameter, denotes whether to retrieve the complete transaction or
  // just
