...
public abstract class BlockExporter {
  ...
  public BlockExporter(final List<Block> blocks) {
    this.blocks = blocks;
  }
  ...
  public void exportBlocks(
    ...
    final long endBlock = maybeEndBlock.orElse(Integer.valueOf(blocks.size()).longValue());
    ...
    for (long i = startBlock; i < endBlock; i++) {
      Optional<Block> maybeBlock = Optional.ofNullable(blocks.get((int) i));
