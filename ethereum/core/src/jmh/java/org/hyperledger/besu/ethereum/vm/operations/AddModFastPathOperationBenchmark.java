...
public class AddModFastPathOperationBenchmark extends TernaryOperationBenchmark {
  ...
  public enum Case {
    ...
    ADDMOD_0_32_32(0, 1, 1),
    ADDMOD_32_0_32(1, 0, 1),
    ADDMOD_0_256_128(0, 8, 4),
    ADDMOD_256_0_128(8, 0, 4),
    ADDMOD_0_256_192(0, 8, 6),
    ADDMOD_256_0_192(8, 0, 6),
    ADDMOD_0_256_256(0, 8, 8),
    ADDMOD_256_0_256(8, 0, 8),
    FULL_RANDOM(-1, -1, -1);
  ...
  protected Operation.OperationResult invoke(final MessageFrame frame) {
    return AddModOperationOptimized.staticOperationFastPath(frame);
  }
}
